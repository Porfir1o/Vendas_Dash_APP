...
grafico_map_estado = px.scatter_geo(
    ...
    scope = 'south america',
    size = 'Preço',
    #size = format_number(df_rec_estado['Preço'],'R$'),
    template = 'seaborn',
...
grafico_map_mensal.update_layout(yaxis_title = 'Receita')
...
grafico_rec_categoria = px.bar(
    ...
    text_auto=True,
    title=' TOP 7 Receita por Categoria'
)
...
grafico_vendas_vendedores = px.bar(
    ...
    text_auto=True,
    title='Top 10 Vendas por Vendedor'
)